<?php include_once("header.php"); ?>
	        ...
	        <div id="destaque-produtos">
	       	    <div class="item" ng-repeat="produto in produtos">
                       ...
                       <a href="produto-{{produto.id_prod}}">
	       	   	           <img src="assets/img/produtos/{{produto.foto_principal}}" alt="{{produto.nome_prod_longo}}">
                       </a>   	   
	       	   	   </div>
            	...
            	<div class="row">
            		<div class="col-md-3" ng-repeat="produto in buscados">
            			<div class="box-produto-info">
	            			<a href="produto-{{produto.id_prod}}">
	            			    <img src="assets/img/produtos/{{produto.foto_principal}}" alt="{{produto.nome_prod_longo}}" class="produto-img">
            		...
            		<div class="col-md-3">
            			<div class="box-produto-info">
	            			<a href="#">
	            			    <img src="assets/img/produtos/panelas.png" alt="Panelas" class="produto-img">
    ...
    <script type="text/javascript">
    	angular.module("shop", []).controller("destaque-controller", function($scope, $http){
            ...
            // $scope.produtos.push({
            //     nome_prod_longo: "Smartphone Motorola Moro X Play Dual Chip Desvloqueado Android 5.1",
            ...
            // $scope.produtos.push({
            //     nome_prod_longo: "Iphone 9 Play Dual Chip Desvloqueado Android 5.1",
            //     foto_principal: "moto-x.png",
            //     preco: "1.259",
            //     centavos: ",10",
            //     parcelas: 8,
            ...
            // $scope.produtos.push({
            //     nome_prod_longo: "Samsung Android",
            //     foto_principal: "moto-x.png",
            //     preco: "1.259",
            //     centavos: ",10",
            //     parcelas: 8,
